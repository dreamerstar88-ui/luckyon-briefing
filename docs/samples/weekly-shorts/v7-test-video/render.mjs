...
const W=1080,H=1920,FPS=30,DUR=58.4;
...
const EVENTS=[
 {i:idxOf('2026-09-01 04:05'),when:'화 저녁 5시 · 9/1',l1:'호르무즈 유조선 피격.',l2:'미 국채 금리 급등.',col:C.down},
 {i:idxOf('2026-09-02 07:00'),when:'수 저녁 8시 · 9/2',l1:'주간 최저 28,927.',l2:'고점 대비 -2.2%.',col:C.down},
 {i:idxOf('2026-09-03 09:35'),when:'목 밤 10시 35분 · 9/3',l1:'미국 개장과 함께',l2:'반등 시작.',col:C.up},
 {i:idxOf('2026-09-04 06:45'),when:'금 저녁 7시 45분 · 9/4',l1:'주간 최고 29,704.',l2:'',col:C.up},
 {i:idxOf('2026-09-04 08:30'),when:'금 저녁 9시 30분 · 9/4',l1:'8월 고용 16.2만 명.',l2:'예상은 5.5만 명이었다.',col:C.hi},
].filter(e=>e.i>0).sort((a,b)=>a.i-b.i);
console.log('사건 인덱스:',EVENTS.map(e=>e.i).join(', '));
