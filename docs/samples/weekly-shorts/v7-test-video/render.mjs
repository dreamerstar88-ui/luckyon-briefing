...
const EVENTS=[
 {i:idxOf('2026-09-01 04:05'),when:'화 저녁 5시',l1:'호르무즈 유조선 피격.',l2:'미 국채 금리 급등.',tag:'유조선 피격',col:C.down,why:'② 5분봉 변동 2위 -0.32% + 뉴스 확인'},
 {i:idxOf('2026-09-02 07:00'),when:'수 저녁 8시',l1:'주간 최저 28,927.',l2:'고점 대비 -2.2%.',tag:'주간 최저',col:C.down,why:'① 주간 최저점'},
 {i:idxOf('2026-09-03 09:35'),when:'목 밤 10시 35분',l1:'미국 개장과 함께',l2:'반등 시작.',tag:'반등 시작',col:C.up,why:'③ 반등 시작 + 5분봉 변동 3위 +0.25%'},
 {i:idxOf('2026-09-04 08:30'),when:'금 저녁 9시 30분',l1:'8월 고용 16.2만 명.',l2:'예상은 5.5만이었다.',tag:'고용지표',col:C.hi,why:'② 5분봉 변동 1위 -0.41% + 고용지표 발표'},
