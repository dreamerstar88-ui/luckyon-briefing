...
## 실측 (EP.03 한국어판, 이 컨테이너 기준)

| | 테스트1 | 테스트2 | 테스트3 |
|---|---|---|---|
| 산출 | 1080×1350 · 2분 12초 · 1.5 MB | 1080×1350 · 1분 00초 · 7.2 MB | 1080×1920 · 1분 00초 · 20.9 MB |
| 렌더 시간 | 8장 합쳐 1분 미만 | 8장 합쳐 약 9분 | 4분 02초 (1,809프레임) |
| 사람 손이 가는 곳 | 카드 타입별 배치 함수 | **없음** (주석 자동 생성) | 없음 |

테스트1 의 2분 12초는 문장 길이에 비례해 자동 산출된 값이라 길다. 상수만 낮추면 1분대로 줄어든다.
분량을 맞추려면 카드당 목표 초를 고정하고 그 안에서 획 속도를 조절하는 편이 낫다.
